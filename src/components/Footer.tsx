    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-red-500">SwiftAssist</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/privacy" className="text-gray-300 hover:text-red-500 transition-colors">Privacy Policy</Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-300 hover:text-red-500 transition-colors">Terms of Service</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Road Assistance St, City, State 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">help@swiftassist.com</span>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-center text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} SwiftAssist. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
